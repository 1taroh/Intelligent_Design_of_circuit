...
from src.preprocessing import LogStandardScaler, HScaler
...
rc_dataset = RCDataset(num_samples=1000, R_range=[50e3, 50e3], C_range=[1e-9, 10e-9], fs=fs)
...
# パリティプロット: R_actual vs R_pred, C_actual vs C_pred
# TODO: 軸をそろえる
